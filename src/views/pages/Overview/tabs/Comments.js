    ...
    <Wrapper>
      ...
      <div className="card">
        ...
        <div className="card-dsc">
          It was really useful having a media team representative in the
      ...
      <div className="card">
        ...
        <div className="card-dsc">
          My manager made it feel easy to suggest different perpsectives.
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-dsc">
          ...
          bibendum mi. Donec hendrerit rutrum metus sagittis accumsan. Nam ac
          sollicitudin lorem. Nam ac tristique turpis, vitae varius quam. Nullam
          et sapien ut libero sollicitudin iaculis. Duis semper tempus sapien
          sed tincidunt. Vestibulum sodales urna sed pulvinar rhoncus.
        </div>
      </div>
    </Wrapper>
  );
