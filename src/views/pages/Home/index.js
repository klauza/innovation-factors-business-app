...
import PlansContent from '../Plans/PlansContent';
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Innovation Factors</title>
        ...
        <meta
          ...
          content="Innovation Factors description"
        />
        <meta property="og:url" content={window.location.origin} />
        <meta property="og:site_name" content="Innovation Factors" />
        <meta
          property="og:image"
          content={`https://images.pexels.com/photos/34123/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260`}
        />
        ...
        <meta
          ...
          content="Innovation Factors twitter description"
        />
      ...
      <Wrapper className="page">
        ...
        <div id="insight" className="insight" ref={insight}>
          ...
          <p>
            Gather structured data from your people to drive improvements in the
            organisation's innovation capacity.
          </p>
        </div>

        <div className="sections">
          {home_icons.map((sec, i) => (
            <IconSection key={i} section={sec} />
          ))}
        </div>
